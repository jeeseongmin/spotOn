  ...
  return (
    <div ref={dropdownRef} className="relative h-10 flex-1">
      ...
      <button
        type="button"
        className={cn(
          "absolute top-0 z-30 flex h-10 w-full select-none items-center justify-between gap-4 rounded-sm border border-gray-middle bg-white px-3 py-2.5 text-small",
