...
import VehicleReservationAdmin from "@/pages/Admin/components/VehicleReservationAdmin";
...
const Admin = () => {
  ...
  const checkRole = async () => {
    // 1차 확인
    if (user.roleId !== "ADMIN") {     // ROLE_ADMIN을 ADMIN으로 수정 2025.5.10
      alertModal.onOpen();
      ...
      if (res.roleId !== "ADMIN") {     // ROLE_ADMIN을 ADMIN으로 수정 2025.5.10
        alertModal.onOpen();
      ...
      <Layout>
        <div className="flex flex-col gap-4">    
          ...
          <Tab variant="enclosed">
            ...
            <Tab.Item label="차량예약 관리" className="relative">
              <VehicleReservationAdmin />
            </Tab.Item>
          </Tab>
        </div>
      </Layout>
