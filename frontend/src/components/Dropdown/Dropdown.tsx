...
const Dropdown = ({
  ...
  return (
    <div ref={dropdownRef} className={cn(dropdownCSS({ variant }), className)}>
      ...
      >
        <div
          className={`flex max-h-60 flex-col overflow-scroll bg-gray-50 ${optionsModal.isOpen ? " animate-dropdown-open border-b border-gray-dull" : "h-0 pointer-events-none"}`}
        >
